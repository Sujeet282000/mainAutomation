...
exports.env = {
    ...
    // ── Database (Supabase) ──
    databaseUrl: required("DATABASE_URL", "postgresql://postgres:postgres@localhost:54322/postgres"),
    supabaseUrl: process.env.SUPABASE_URL ?? "http://localhost:54324",
    supabaseAnonKey: process.env.SUPABASE_ANON_KEY ?? "",
    supabaseServiceKey: required("SUPABASE_SERVICE_KEY", "replace-with-service-role-key"),
    // ── Redis ──
    ...
    serviceToken: required("SERVICE_TOKEN", "replace-with-a-48-plus-character-random-secret"),
    serviceTokenMaxAgeSeconds: Number(process.env.SERVICE_TOKEN_MAX_AGE_SECONDS ?? 60),
    // ── CORS ──
