...
export class EngineError extends Error {
  constructor(public readonly errorClass: ErrorClass, public readonly code: string, message?: string) {
    super(message ?? code);
...
export class Executor {
  ...
  private async pause(run: { id: string; transitionEpoch?: number }, cursor: number, context: Record<string, unknown>, outcome: { kind?: string; reason: string; resumeAt?: string }): Promise<void> {
