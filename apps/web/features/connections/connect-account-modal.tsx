...
type AuthSchema = { authType: string; fields: AuthField[]; oauthProvider?: string; appName?: string; note?: string; capabilities?: { triggers: number; actions: number; searches: number } };
